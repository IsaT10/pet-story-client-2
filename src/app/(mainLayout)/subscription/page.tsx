...
export default function SubscriptionPage() {
  return (
    <div className='flex flex-col items-center justify-center min-h-[calc(100vh-72.8px)]'>
      <h2 className='text-2xl md:text-4xl font-bold mb-6 pt-10 leading-none'>
        All plans
      </h2>
      <div className='flex pt-8 pb-16 md:flex-row flex-col-reverse gap-10 lg:gap-20 items-start justify-center'>
        <div className='bg-white shadow-[0_5px_15px_rgba(0,0,0,0.15)]  w-[350px] lg:w-[400px] px-8 py-12 rounded-2xl'>
